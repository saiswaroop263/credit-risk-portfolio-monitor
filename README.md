...
Metrics from training on synthetic data with 15% default rate:

| Model | AUC-ROC | Precision | Recall | F1 Score |
|-------|---------|-----------|--------|----------|
| Logistic Regression | ~0.75 | ~0.40 | ~0.55 | ~0.46 |
| XGBoost | ~0.82 | ~0.48 | ~0.60 | ~0.53 |

*Note: These are honest metrics from real training on synthetic data.*
